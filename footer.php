     ...
     <div class="container">  
      ...
      <div class="col-lg-2 col-md-6 socialmedia-footer" style="text-align: left;">
       ...
       <h1><?php _e('USER', 'falgun'); ?></h1>
        ...
        <?php
            echo '<div class="copyright">' . sprintf(__('Free responsive Osclass theme by <a target="_blank" title="osclasswizards" href="%s">OsclassWizards</a>','falgun'), 'http://www.osclasswizards.com/') . '</div>';
        ?> 
    </div>
</div>
